SUMMARY = "OCPP schema + protobuf-c v2.1 test"
LICENSE = "CLOSED"
...
do_generate() {
    ...
    install -d ${S}/output/gen/cpp_out/ocpp/v21
    cd ${S}/output/proto/OCPP/v21

    # 用 host 端的 protoc 來產生（protobuf-native 提供）
    ${STAGING_BINDIR_NATIVE}/protoc -I=. --cpp_out=${S}/output/gen/cpp_out/ocpp/v21 \
...
do_install() {
    ...
    install -m 0755 ${B}/test_v21 ${D}${bindir}/ocpp-v21-test
}

FILES:${PN} += "${bindir}/ocpp-v21-test"